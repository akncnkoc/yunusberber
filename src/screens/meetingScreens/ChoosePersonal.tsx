...
const ChoosePersonal = ({ navigation, route }: any) => {
    ...
    <View style={{ flex: 1 }}>
            ...
            <>
              ...
              >
                ...
                >
                  <TouchableOpacity
                    activeOpacity={0.75}
                    onPress={() => selectPersonal(item.id)}
                  >
                    <View
                      style={{
                        position: "absolute",
                    ...
                    >
                      <Image
                        ...
                        source={require("@/assets/images/SuccessVector.png")}
                      />
                    </View>
                    <Image
                      source={{
      ...
      >
        ...
        >
          ...
          >
            {!personalIndex ? "Görsele Tıklayarak Seçim Yap" : "Devam Et"}
          </BerberText>
        </BerberButton>
      </View>
    </View>
